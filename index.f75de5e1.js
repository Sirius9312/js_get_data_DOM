...
const arrPopulations = [
    ...populations
].map((population)=>+population.textContent.split(",").join(""));
const totalCountPeople = arrPopulations.reduce((prevPeople, people)=>prevPeople + people, 0);
const averageCountPeople = Math.ceil(arrPopulations.reduce((prevPeople, people)=>prevPeople + people, 0) / arrPopulations.length);
